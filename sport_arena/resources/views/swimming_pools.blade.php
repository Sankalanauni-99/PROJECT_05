...
<div class="background-section">
    ...
    <div class="fitness_image">
        <img src="{{ asset('images/swimming_image.png') }}">
    </div>
    ...
    <div class="container mt-5 mb-5">
        ...
        <div class="fitness-center-wrapper d-flex justify-content-around flex-wrap mt-4">
            ...
            <div class="fitness-card">
                <img src="{{ asset('images/SeaScape.jpeg') }}" class="fitness-image" alt="SeaScape">
                <div class="fitness-card-body">
                    <h5 class="fitness-title">SeaScape</h5>
                    <p class="fitness-details">
                        <strong>Swimming pool in MATARA</strong><br>
                        2+ years in business<br>
                        <i>Open:9.00 am</i><br>
                        <i>Close: 8.00 pm</i><br>
                        076 408 4498<br>
            ...
            <!-- Swimming pool 3 -->
            <div class="fitness-card">
                <img src="{{ asset('images/Leisure Land.jpeg') }}" class="fitness-image" alt="Leisure Land">
                <div class="fitness-card-body">
                    <h5 class="fitness-title">Leisure Land</h5>
                    <p class="fitness-details">
                        <strong>Swimming pool in MATARA</strong><br>
